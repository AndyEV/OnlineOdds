...
namespace odd.web.Factory
{
    public class OddFactory
    {
        ...
        public static Odd UpdateOddComand(UpdateOdd dto) => new Odd { Id = dto.Id, TeamId = dto.TeamId, HomeOdd = dto.HomeOdd, DrawOdd = dto.DrawOdd, AwayOdd = dto.AwayOdd, UpdatedAt = DateTime.Now };
